    ...
    <div>
      <div className='intro text-center text-[#C9CED6] mt-15 mb-5 px-6'>
        ...
        <div className="flex flex-col items-center justify-center gap-2 m-5">
          ...
          <div className='mt-8 '>
            <label htmlFor="check" className="flex bg-gray-100 cursor-pointer relative w-12 h-6 rounded-full">
              <input type="checkbox" id='check' className='sr-only peer' />
              <span className='w-2/5 h-4/5 bg-rose-300 absolute rounded-full left-1 top-1 peer-checked:bg-rose-600 peer-checked:left-6 transition-all duration-500'></span>
            </label>
          </div>
          <p className="text-sm text-gray-400 mt-8">Auto paste from clipboard</p>
          </div>
